...
class TasksDataset(Dataset):
    ...
    def shuffle(self):
        pairs = list(zip(self.src_tokenizer.all_sentences, self.tgt_tokenizer.all_sentences))
        
        random.shuffle(pairs)
        
        self.src_tokenizer.all_sentences = []
        self.tgt_tokenizer.all_sentences = []
        for src, tgt in pairs:
            self.src_tokenizer.all_sentences.append(src)
            self.tgt_tokenizer.all_sentences.append(tgt)
